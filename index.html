...
<html lang="pt_br">
  <head>
    ...
    <meta name="description" content="Sala de estudos CompCEDERJ">
    <meta name="keywords" content="CompCEDERJ, Tecnologia, Sistemas, Computação, Sala, Estudos, thcborges, marcello-telles">
    <meta name="author" content="Thiago da Cunha Borges thcborges, Marcello Telles marcello-telles">
  ...
  <body id="page-top">
    <!-- Navigation -->
    <nav class="navbar navbar-expand-lg fixed-top box-sombreado" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger " href="#page-top">
            <img class="img-fluid" src="img/logo-novo-nav.png" alt="">
            Sala de Estudos
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger mb-1" href="#disciplinas">Disciplinas</a>
            </li>
            <!--
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger mb-1" href="#participe">Participe</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger mb-1" href="#about">Dicas</a>
            </li>
            -->
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger mb-1" href="#contact">Contato</a>
            </li>
          </ul>
        </div>
      </div>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" role="tabpanel" id="oportunidades">
                ...
                <div>
                  ...
                  <!-- <div class="oportunidade borda-superior">
                    <a href="http://visag.io/H9d1" target="_blank">
                      <img src="img/divulgacao/VSGTalentos18-2_banner.png" class="col-md-12" style="padding-bottom: 20px">
                    </a>
                    <p><i>"A Visagio oferece um ambiente livre de hierarquias, no qual desde os sócios até os mais recentes estagiários possuem a mesma liberdade de contribuir com a plataforma, e isso é bem nítido no dia-a-dia. Existem inúmeras oportunidades de aprendizado, entre as mais diversas áreas da computação. É a oportunidade perfeita para quem, como eu, busca o crescimento pessoal e profissional."</i> - <a href="https://api.whatsapp.com/send?phone=5521987649045" target="_blank">
                    Marcello Telles</a>, aluno do CEDERJ</p>

                    <p>Você sabe programar e gosta de desenvolvimento?  Tem interesse em trabalhar com extração e análise de dados? Quer participar de todas as etapas de um projeto, desde o desenho da solução, passando por sua implantação e atuação na operação assistida? Então se inscreva no processo seletivo da Visagio Tecnologia!</p>

                    <p>Segundo o Instituto Great Place do Work, a Visagio é a segunda melhor empresa para se trabalhar no Rio, em 2018. Com atuação em projetos de Supply Chain & Operações, Administrativo & Finanças, Gente & Gestão e Gestão Interina para empresas dos mais diversos setores e segmentos de atuação, a Visagio tem escritório no Rio de Janeiro, São Paulo, Perth, Londres e Moscou e já desenvolveu projetos em mais de 30 países.</p>

                    <p>Nós acreditamos em pessoas boas e do bem, valorizamos a boa formação, mas prezamos acima dela o companheirismo, ética e vontade de encantar o cliente.</p>

                    <p>O valor da bolsa inicial é de R$2000,00, mais benefícios e participação nos lucros e resultados.</p>

                    <p>Se você busca uma empresa que lhe possibilite um crescimento acelerado e a oportunidade de atuar em contato direto com o cliente e, tudo isso, dentro de um ambiente colaborativo, venha para o nosso time!</p>

                    <p><b>Inscreva-se até o dia 26/8</b> em https://www.visagiotalentos.com/.</p>
                  </div> -->
                </div>
              </div>
              <div class="tab-pane" role="tabpanel" id="AL">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=AL" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
              ...
              <div class="tab-pane" role="tabpanel" id="AS">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=AS" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="APS">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=APS" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="BD">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=BD" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="CG">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=CG" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
              ...
              <div class="tab-pane" role="tabpanel" id="CPW">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=CPW" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="DP">
                ...
                <div class="participe text-center">
                  <a href="redirect.php?disciplina=DP" target="_blank"><img src="img/drive.png" class="img-fluid" alt=""></a>
                </div>
              ...
              <div class="tab-pane" role="tabpanel" id="EE">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=EE" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="ES">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=ES" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
              ...
              <div class="tab-pane" role="tabpanel" id="ED">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=ED" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="FC">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=FC" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
              ...
              <div class="tab-pane" role="tabpanel" id="FAC">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=FAC" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="FP">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=FP" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="II">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=II" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1"></div>
                <div class="dicas">
                  <!--Dicas Inglês-->
              ...
              <div class="tab-pane" role="tabpanel" id="IaI">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=IaI" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
                  <p>Decodificação de textos atuais de informática em língua inglesa; Gramática contextualizada; Gramática sistematizada de itens referentes à linguagem tecnológica específica.
                  </p>
                </div>
              ...
              <div class="tab-pane" role="tabpanel" id="LIBRAS">
                ...
                <div class="participe text-center">
                  <a href="redirect.php?disciplina=LIBRAS" target="_blank"><img src="img/drive.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1"></div>
                <div class="dicas">
                  <!--Dicas LIBRAS-->
              ...
              <div class="tab-pane" role="tabpanel" id="MB">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=MB" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1"></div>
                <div class="dicas">
              ...
              <div class="tab-pane" role="tabpanel" id="MC">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=MC" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="MI">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=MI" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="OC">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=OC" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="PE">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=PE" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="PIG">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=PIG" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="PAW">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=PAW" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="POO">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=POO" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="PDA">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=PDA" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="RC1">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=RC1" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="RC2">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=RC2" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="SO">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=SO" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
              ...
              <div class="tab-pane" role="tabpanel" id="TCC">
                ...
                <div class="participe text-center">
                  ...
                  <a href="redirect.php?disciplina=TCC" target="_blank"><img src="img/whatsapp.png" class="img-fluid" alt=""></a>
                </div>
                <div class="ementa mb-1">
                  <h4>Ementa</h4>
    ...
    <footer class="footer text-center">
      <div class="container">
        <div class="row">
          <div class="w-100">
            <h4 class="text-uppercase">Construído por:</h4>
          </div>
        </div>
        <div class="row">
          <div class="col-md mb-5 mb-lg-0">
            <div class="lead mb-4 border rounded p-3">
              <div class="mb-2">
                <img src="https://avatars3.githubusercontent.com/u/19919929?s=460&v=4" alt="Thiago da Cunha Borges" class="img-resposive w-25 img-circle border mr-3"> Thiago da Cunha Borges
              </div>
              <ul class="list-inline">
                <li class="list-inline-item">
                  <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://t.me/thcborges" target="_blank">
                    <i class="fa fa-fw fa-telegram"></i>
                  </a>
                </li>
                <li class="list-inline-item">
                  <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://api.whatsapp.com/send?phone=5521976377675" target="_blank">
                    <i class="fa fa-fw fa-whatsapp"></i>
                  </a>
                </li>
                <li class="list-inline-item">
                  <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://www.linkedin.com/in/thcborges/" target="_blank">
                    <i class="fa fa-fw fa-linkedin"></i>
                  </a>
                </li>
                <li class="list-inline-item">
                  <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://github.com/thcborges" target="_blank">
                    <i class="fa fa-fw fa-github"></i>
                  </a>
                </li>
                <li class="list-inline-item">
                  <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://www.facebook.com/thcborges" target="_blank">
                    <i class="fa fa-fw fa-facebook"></i>
                  </a>
                </li>
                <li class="list-inline-item">
                  <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://twitter.com/thcborges_" target="_blank">
                    <i class="fa fa-fw fa-twitter"></i>
                  </a>
                </li>
                <li class="list-inline-item">
                  <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://plus.google.com/u/0/+ThiagodaCunhaBorges" target="_blank">
          ...
          <div class="col-md mb-5 mb-lg-0">
            <div class="lead mb-4 border rounded p-3">
              <div class="mb-2">
                <img src="https://avatars0.githubusercontent.com/u/20986439?s=460&v=4" alt="Marcello Telles" class="img-resposive w-25 img-circle border mr-3 mb-2"> Marcello Telles
                <ul class="list-inline">
                  <li class="list-inline-item">
                    <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://t.me/telles1" target="_blank">
                      <i class="fa fa-fw fa-telegram"></i>
                    </a>
                  </li>
                  <li class="list-inline-item">
                    <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://api.whatsapp.com/send?phone=5521987649045" target="_blank">
                      <i class="fa fa-fw fa-whatsapp"></i>
                    </a>
                  </li>
                  <li class="list-inline-item">
                    <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://www.linkedin.com/in/marcello-telles-1b2b12123/" target="_blank">
                      <i class="fa fa-fw fa-linkedin"></i>
                    </a>
                  </li>
                  <li class="list-inline-item">
                    <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://github.com/marcello-telles" target="_blank">
                      <i class="fa fa-fw fa-github"></i>
                    </a>
                  </li>
                  <li class="list-inline-item">
                    <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://www.facebook.com/mtelles2" target="_blank">
                      <i class="fa fa-fw fa-facebook"></i>
                    </a>
                  </li>
                </ul>
          ...
          <div class="col-md mb-5 mb-lg-0">
            <div class="lead mb-0">
              <img src="https://avatars0.githubusercontent.com/u/20986439?s=460&v=4" alt="Marcello Telles" class="img-resposive w-25 img-circle border"> Marcello Telles
            </div>
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container">
        <small>Copyright &copy; CompCEDERJ 2018</small>
      </div>
    </div>
    ...
    <script src="vendor/jquery/build.js"></script>
