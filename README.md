...
Esse site usa frameworks como [Bootstrap 4](http://getbootstrap.com/docs/4.0/getting-started/introduction/) e [jQuery](https://learn.jquery.com/) aprenda essas ferramentas ou tenha a documentação das mesmas abertas antes de tentar fazer alteração no código.

Para fazer alterações no CSS do site use o arquivo `css/freelancer.css`. 

No javascript, use o arquivo `js/freelancer.js`. Atenção ao fato de que este arquivo usa jQuery. O uso de javascript comum pode ser feito, mas cuidado com o que será mexido.


## Este foi criado com base em: [Start Bootstrap - Freelancer](https://startbootstrap.com/template-overviews/freelancer/)
